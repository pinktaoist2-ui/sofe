...
const bakeryImg = "https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&w=800&q=80";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-pink-50">
      <div className="flex w-full max-w-4xl bg-white rounded-2xl shadow-lg overflow-hidden">
        ...
        <div className="hidden md:block w-1/2 bg-pink-100 relative">
          <img
            src={bakeryImg}
            alt="Bakery"
